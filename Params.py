...
neighbourhood_count_values = np.linspace(5, 5, 250).tolist()
activation_rate_values = np.linspace(0, 1, 10).tolist()

combos = [
    {"density": round(h, 4), "defector_frac": round(d, 4), "neighbourhood_count": round(l, 4), "activation_rate": round(s, 4)}
