...
ax.set_title("Final segregation (H) heatmap over the activation rate and agent density")
...
ax.set_ylabel("agent density")
ax.set_title("Final morans I heatmap over the neighbourhood count and agent density")
...
ax.set_title("Final neighbourhood variance heatmap over the agent density and activation rate")
