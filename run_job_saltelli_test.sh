...
#SBATCH --output=results_saltelli/schelling_test_%A_%a.out  # %A = array job ID, %a = task index
...
uv run python /gpfs/home4/scur0391/projects/ABM/Run_no_solara.py \
    ...
    --n-seeds 3 \
    --max-steps 500 \
    --params-file /gpfs/home4/scur0391/projects/ABM/results_saltelli/params_test.json
